...
void MyController::MakeADecision()
{
	...
	//Vector2f nearby = information->vector<Vector2f> nearby_enenmy_tank_position;
	//Vector2u enemyPos = near
	/*get index of enemies nearby
	Find closest enemy to me
	change target map index to further away from enemy
	*/
